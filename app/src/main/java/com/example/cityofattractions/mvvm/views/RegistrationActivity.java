...
import com.example.cityofattractions.mvvm.viewModel.CreateViewModel;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerName = (EditText) findViewById(R.id.editTextTextPersonName);
        registerLogin = (EditText) findViewById(R.id.editTextTextEmailAddress2);
        registerPassword = (EditText) findViewById(R.id.editTextTextPassword2);
